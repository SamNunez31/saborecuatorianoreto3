    ...
    <div class="d-flex">
      ...
      <aside class="sidebar-admin d-flex flex-column" role="navigation" aria-label="Panel de administración">
        ...
        <nav class="flex-grow-1 p-2">
          ...
          <a class="nav-link d-flex align-items-center gap-2 px-3 py-2 mb-1" routerLink="/admin/inventario"   routerLinkActive="active"><span aria-hidden="true">📦</span> Inventario</a>
          <a class="nav-link d-flex align-items-center gap-2 px-3 py-2 mb-1" routerLink="/admin/proveedores"  routerLinkActive="active"><span aria-hidden="true">🚚</span> Proveedores</a>
        </nav>
